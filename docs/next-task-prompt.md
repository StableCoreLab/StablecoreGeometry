...
- 已新增显式 gap 测试 `Conversion3dGapTest::QuadSharedEdgeChainVertexConsistencyRemainsOpen`，固定化 quad-face shared-edge chain + support-plane mismatch 下的开放问题；下一步直接以该用例为靶点推进算法实现并转正 capability
