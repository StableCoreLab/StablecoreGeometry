...
namespace Geometry
{
    struct Direction3d
    {
        ...
        [[nodiscard]] static Direction3d FromVector( const Vector3d &vector,
        ...
        [[nodiscard]] Vector3d Vector() const { return value; }

        [[nodiscard]] Direction3d Reverse() const { return Direction3d::FromVector( -value ); }

        [[nodiscard]] bool AlmostEquals( const Direction3d &other,
                                         double angleEps = kDefaultEpsilon ) const
        {
