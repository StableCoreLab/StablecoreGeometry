...
TEST(BooleanGapTest, UltraThinRepeatedOverlapFamiliesRemainOpen)
{
    ...
    (void)first;
    (void)second;
    GTEST_SKIP() << "Known gap: ultra-thin repeated-overlap families still need stronger boolean recovery.";
}
