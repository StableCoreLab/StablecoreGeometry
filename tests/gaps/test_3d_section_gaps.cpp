...
TEST(Section3dGapTest, NonPlanarDominantSectionGraphRemainsOpen)
{
    ...
    GTEST_SKIP() << "Known 3D gap: non-planar dominant section graph and ambiguous non-manifold contour stitching semantics in non-planar-dominant sections are still open. "
                    ...
                    "rectangular-prism y-axis section on BrepBody path (four-segment 2\u00d71 rectangle contour, perimeter=6), "
                    "unit-cube z-axis section on PolyhedronBody path (four-segment 1\u00d71 square contour, perimeter=4), "
                    "and unit-cube z-axis section on BrepBody path (four-segment 1\u00d71 square contour, perimeter=4).";
}
