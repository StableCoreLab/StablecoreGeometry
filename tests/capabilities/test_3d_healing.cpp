...
// has a non-horizontal (vertically-oriented) normal 鈥?the y=0 plane with
...
// Demonstrates aggressive healing handles a four-shell body 鈥?one closed plus
// two independent eligible single-face open shells plus one ineligible 鈥?and
...
TEST(Healing3dCapabilityTest, AggressiveFourShellTwoEligibleOneIneligibleDeterministicBehavior)
{
    std::vector<BrepVertex> vertices{
        ...
        BrepVertex(Point3d{7.0, 1.0, 0.0}),
        BrepVertex(Point3d{6.0, 1.0, 0.0}),
        // Shell 3: ineligible 鈥?vertex 14 has z-offset (not on z=0 support plane)
        BrepVertex(Point3d{9.0, 0.0, 0.0}),
        BrepVertex(Point3d{10.0, 0.0, 0.0}),
        BrepVertex(Point3d{10.0, 1.0, 0.15}),
        BrepVertex(Point3d{9.0, 1.0, 0.0})};
