...
TEST(Healing3dCapabilityTest, AggressiveHealingSkipsCompetingSharedBoundaryEdgeEligibleShells)
{
    ...
    const BrepLoop competingA0({BrepCoedge(7, false), BrepCoedge(8, false), BrepCoedge(9, false), BrepCoedge(10, false)});
    const BrepLoop competingA1({BrepCoedge(11, false), BrepCoedge(12, false), BrepCoedge(13, false), BrepCoedge(8, true)});
    const BrepLoop competingB0({BrepCoedge(14, false), BrepCoedge(15, false), BrepCoedge(16, false), BrepCoedge(17, false)});
    const BrepLoop competingB1({BrepCoedge(18, false), BrepCoedge(19, false), BrepCoedge(20, false), BrepCoedge(15, true)});
    ...
    const BrepFace competingFaceA0(std::shared_ptr<Surface>(planeSurface.Clone().release()), competingA0);
    const BrepFace competingFaceA1(std::shared_ptr<Surface>(planeSurface.Clone().release()), competingA1);
    const BrepFace competingFaceB0(std::shared_ptr<Surface>(planeSurface.Clone().release()), competingB0);
    const BrepFace competingFaceB1(std::shared_ptr<Surface>(planeSurface.Clone().release()), competingB1);
...
TEST(Healing3dCapabilityTest, AggressiveHealingKeepsCompetingPairOpenButClosesVertexTouchShell)
{
    ...
    const BrepLoop shellB0({BrepCoedge(7, false), BrepCoedge(8, false), BrepCoedge(9, false), BrepCoedge(10, false)});
    const BrepLoop shellB1({BrepCoedge(11, false), BrepCoedge(12, false), BrepCoedge(13, false), BrepCoedge(8, true)});
    const BrepLoop shellC0({BrepCoedge(14, false), BrepCoedge(15, false), BrepCoedge(16, false), BrepCoedge(17, false)});
    const BrepLoop shellC1({BrepCoedge(18, false), BrepCoedge(19, false), BrepCoedge(20, false), BrepCoedge(15, true)});
...
TEST(Healing3dCapabilityTest, AggressiveHealingKeepsClosedShellAndCompetingPairWhileClosingVertexTouchShell)
{
    ...
    const BrepLoop shellB0({BrepCoedge(11, false), BrepCoedge(12, false), BrepCoedge(13, false), BrepCoedge(14, false)});
    const BrepLoop shellB1({BrepCoedge(15, false), BrepCoedge(16, false), BrepCoedge(17, false), BrepCoedge(12, true)});
    const BrepLoop shellC0({BrepCoedge(18, false), BrepCoedge(19, false), BrepCoedge(20, false), BrepCoedge(21, false)});
    const BrepLoop shellC1({BrepCoedge(22, false), BrepCoedge(23, false), BrepCoedge(24, false), BrepCoedge(19, true)});
...
TEST(Healing3dCapabilityTest, AggressiveHealingPartiallyRepairsMixedOpenShells)
{
    ...
    const BrepHealing3d healed = Heal(mixedOpenBody, GeometryTolerance3d{}, HealingPolicy3d::Aggressive);
    ASSERT_TRUE(healed.success);
    ASSERT_TRUE(healed.body.IsValid());
    ASSERT_EQ(healed.body.ShellCount(), 2);
    ASSERT_TRUE(healed.body.ShellAt(0).IsClosed());
...
TEST(Healing3dCapabilityTest, AggressiveHealingRejectsNonPlanarSharedEdgeShellForBoundaryCap)
{
    std::vector<BrepVertex> vertices{
        ...
        BrepVertex(Point3d{1.0, 1.0, 0.0}),
        BrepVertex(Point3d{0.0, 1.0, 0.0}),
        BrepVertex(Point3d{2.0, 0.0, 0.5}),
        BrepVertex(Point3d{2.0, 1.0, 0.5})};
    ...
    const BrepLoop firstLoop({BrepCoedge(0, false), BrepCoedge(1, false), BrepCoedge(2, false), BrepCoedge(3, false)});
    const BrepLoop secondLoop({BrepCoedge(4, false), BrepCoedge(5, false), BrepCoedge(6, false), BrepCoedge(1, true)});
...
TEST(Healing3dCapabilityTest, AggressiveHealingThreeShellEligibleMultiFaceHoledSupportPlaneMismatch)
{
    std::vector<BrepVertex> vertices{
        ...
        BrepVertex(Point3d{11.0, 0.0, 0.0}),
        BrepVertex(Point3d{12.0, 0.0, 0.0}),
        BrepVertex(Point3d{12.0, 1.0, 0.10}),
        BrepVertex(Point3d{11.0, 1.0, 0.0})};
    ...
    const BrepFace eligibleFaceA(std::shared_ptr<Surface>(eligibleMismatchedSurface.Clone().release()), eligibleHoledOuter, {eligibleHoledHole});
    const BrepFace eligibleFaceB(std::shared_ptr<Surface>(eligibleMismatchedSurface.Clone().release()), eligiblePlain);
    const BrepFace ineligibleFace(std::shared_ptr<Surface>(ineligibleSupport.Clone().release()), ineligibleLoop);
...
TEST(Healing3dCapabilityTest, AggressiveHealingMixedSupportMismatchWithIneligibleMultiFaceShell)
{
    ...
    const BrepLoop closedOuterReversed({BrepCoedge(3, true), BrepCoedge(2, true), BrepCoedge(1, true), BrepCoedge(0, true)});
    const BrepLoop eligibleOuter({BrepCoedge(4, false), BrepCoedge(5, false), BrepCoedge(6, false), BrepCoedge(7, false)});
    const BrepLoop ineligibleA({BrepCoedge(8, false), BrepCoedge(9, false), BrepCoedge(10, false), BrepCoedge(11, false)});
    const BrepLoop ineligibleB({BrepCoedge(12, false), BrepCoedge(13, false), BrepCoedge(14, false), BrepCoedge(9, true)});
    ...
    const BrepFace closedFaceA(std::shared_ptr<Surface>(closedSurface.Clone().release()), closedOuter);
    const BrepFace closedFaceB(std::shared_ptr<Surface>(closedSurface.Clone().release()), closedOuterReversed);
    const BrepFace eligibleFace(std::shared_ptr<Surface>(eligibleMismatch.Clone().release()), eligibleOuter);
...
TEST(Healing3dCapabilityTest, AggressiveHealingSupportMismatchEligibleMultiFaceMissingTrimsWithIneligibleMultiFace)
{
    std::vector<BrepVertex> vertices{
        ...
        BrepVertex(Point3d{11.0, 0.0, 0.0}),
        BrepVertex(Point3d{12.0, 0.0, 0.0}),
        BrepVertex(Point3d{12.0, 1.0, 0.0}),
        BrepVertex(Point3d{11.0, 1.0, 0.0}),
        BrepVertex(Point3d{13.0, 0.0, 0.0}),
        BrepVertex(Point3d{13.0, 1.0, 0.0})};
    ...
    const BrepLoop eligibleHoledHole({BrepCoedge(8, false), BrepCoedge(9, false), BrepCoedge(10, false), BrepCoedge(11, false)});
    const BrepLoop eligiblePlain({BrepCoedge(12, false), BrepCoedge(13, false), BrepCoedge(14, false), BrepCoedge(15, false)});
    const BrepLoop ineligibleA({BrepCoedge(16, false), BrepCoedge(17, false), BrepCoedge(18, false), BrepCoedge(19, false)});
    const BrepLoop ineligibleB({BrepCoedge(20, false), BrepCoedge(21, false), BrepCoedge(22, false), BrepCoedge(17, true)});
    ...
    const BrepFace eligibleFaceA(std::shared_ptr<Surface>(eligibleMismatch.Clone().release()), eligibleHoledOuter, {eligibleHoledHole});
    const BrepFace eligibleFaceB(std::shared_ptr<Surface>(eligibleMismatch.Clone().release()), eligiblePlain);
    const BrepFace ineligibleFaceA(std::shared_ptr<Surface>(ineligibleSurface.Clone().release()), ineligibleA);
    const BrepFace ineligibleFaceB(std::shared_ptr<Surface>(ineligibleSurface.Clone().release()), ineligibleB);
