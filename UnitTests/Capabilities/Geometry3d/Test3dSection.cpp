...
namespace
{
    ...
    PolyhedronBody BuildThreeCoplanarStripFacesBody()
    {
        return PolyhedronBody(
            { PolyhedronFace3d(
                  Plane::FromPointAndNormal( Point3d{ 0.0, 0.0, 0.0 }, Vector3d{ 0.0, 0.0, 1.0 } ),
                  PolyhedronLoop3d( { Point3d{ 0.0, 0.0, 0.0 }, Point3d{ 1.0, 0.0, 0.0 },
                                      Point3d{ 1.0, 1.0, 0.0 }, Point3d{ 0.0, 1.0, 0.0 } } ) ),
              PolyhedronFace3d(
                  Plane::FromPointAndNormal( Point3d{ 1.0, 0.0, 0.0 }, Vector3d{ 0.0, 0.0, 1.0 } ),
                  PolyhedronLoop3d( { Point3d{ 1.0, 0.0, 0.0 }, Point3d{ 2.0, 0.0, 0.0 },
                                      Point3d{ 2.0, 1.0, 0.0 }, Point3d{ 1.0, 1.0, 0.0 } } ) ),
              PolyhedronFace3d(
                  Plane::FromPointAndNormal( Point3d{ 2.0, 0.0, 0.0 }, Vector3d{ 0.0, 0.0, 1.0 } ),
                  PolyhedronLoop3d( { Point3d{ 2.0, 0.0, 0.0 }, Point3d{ 3.0, 0.0, 0.0 },
    ...
    {
        const Plane translatedPlane =
            Plane::FromPointAndNormal( face.SupportPlane().origin + delta, face.SupportPlane().normal );
...
TEST( Section3dCapabilityTest, SlantedCubeSectionBuildsSingleAreaComponent )
{
    ...
    const Plane slantedCut =
        Plane::FromPointAndNormal( Point3d{ 0.0, 0.0, 0.5 }, Vector3d{ 1.0, 0.0, 1.0 } );
...
TEST( Section3dCapabilityTest, NonAxisAlignedCubeSectionHasSingleHexLikeContour )
{
    ...
    const Plane cut = Plane::FromPointAndNormal( Point3d{ 0.5, 0.5, 0.5 }, Vector3d{ 1.0, 1.0, 1.0 } );
...
TEST( Section3dCapabilityTest, BrepBodyAdjacentCoplanarFacesMergeIntoSinglePolygon )
{
    ...
    const Plane cut = Plane::FromPointAndNormal( Point3d{ 0.0, 0.0, 0.0 }, Vector3d{ 0.0, 0.0, 1.0 } );
    const auto section = Section( converted.body, cut );
    ASSERT_TRUE( section.success );
    ASSERT_TRUE( section.IsValid() );
    ASSERT_EQ( section.polygons.size(), 1 );
...
TEST( Section3dCapabilityTest, TwoDisjointNonPlanarLoopsStaySeparatedInSameSectionPlane )
{
    ...
    const Plane cut = Plane::FromPointAndNormal( Point3d{ 0.0, 0.0, 0.5 }, Vector3d{ 0.0, 0.0, 1.0 } );
...
TEST( Section3dCapabilityTest,
      MixedCoplanarStripWithVertexAndEdgeAttachedOpenContoursBuildsMixedContent )
{
...
TEST( Section3dCapabilityTest,
      BrepMixedCoplanarStripWithVertexAndEdgeAttachedOpenContoursBuildsMixedContent )
{
...
TEST( Section3dCapabilityTest,
      MixedCoplanarStripWithDetachedVertexAndEdgeAttachedOpenContoursBuildsMixedContent )
{
    const PolyhedronBody body =
        BuildMixedCoplanarStripWithDetachedVertexAndEdgeAttachedOpenSectionBody();
    ASSERT_TRUE( body.IsValid() );
...
TEST( Section3dCapabilityTest,
      BrepMixedCoplanarStripWithDetachedVertexAndEdgeAttachedOpenContoursBuildsMixedContent )
{
    const PolyhedronBody polyBody =
        BuildMixedCoplanarStripWithDetachedVertexAndEdgeAttachedOpenSectionBody();
    ASSERT_TRUE( polyBody.IsValid() );
...
TEST( Section3dCapabilityTest,
      BrepNonPlanarLoopWithInteriorOpenSpurKeepsClosedContourAndOpenContourSeparate )
{
...
{
    const PolyhedronBody polyBody =
        BuildMixedMergedHoleAndAdjacentNonPlanarWithDetachedOpenSectionBody();
    ASSERT_TRUE( polyBody.IsValid() );
...
{
    const PolyhedronBody body =
        BuildMixedMergedHoleAndAdjacentNonPlanarWithEdgeAttachedOpenSectionBody();
    ASSERT_TRUE( body.IsValid() );
...
{
    const PolyhedronBody body =
        BuildMixedMergedHoleAndAdjacentNonPlanarWithVertexAttachedOpenSectionBody();
    ASSERT_TRUE( body.IsValid() );
...
TEST( Section3dCapabilityTest,
      BrepMixedMergedAreaWithInteriorHoleAndVertexAttachedOpenContourStaysMixed )
{
    const PolyhedronBody polyBody =
        BuildMixedMergedHoleAndAdjacentNonPlanarWithVertexAttachedOpenSectionBody();
    ASSERT_TRUE( polyBody.IsValid() );
...
TEST( Section3dCapabilityTest, UnitCubeMidPlaneSectionYieldsFourSegmentClosedContour )
{
    ...
    const Plane midCut =
        Plane::FromPointAndNormal( Point3d{ 0.5, 0.5, 0.5 }, Vector3d{ 0.0, 1.0, 0.0 } );
...
TEST( Section3dCapabilityTest, ObliquePrismSectionYieldsDeterministicContourLength )
{
    ...
    const Plane cut = Plane::FromPointAndNormal( Point3d{ 0.5, 0.289, 0.5 }, Vector3d{ 0.0, 0.0, 1.0 } );
    const auto section = Section( prism, cut );
    ASSERT_TRUE( section.success );
    ASSERT_TRUE( section.IsValid() );

    // Horizontal mid-section of a triangular prism = triangle 茅藛?closed contour
...
TEST( Section3dCapabilityTest, UnitCubeXAxisSectionYieldsDeterministicRebarPerimeter )
{
    ...
    // parallel and uncut.
    const Plane cut = Plane::FromPointAndNormal( Point3d{ 0.5, 0.5, 0.5 }, Vector3d{ 1.0, 0.0, 0.0 } );
    const auto section = Section( cubeBody, cut );
    ASSERT_TRUE( section.success );
    ASSERT_TRUE( section.IsValid() );
...
// Demonstrates that cutting a 2猫锟?猫锟? rectangular prism (box) at its z mid-plane
// (z=0.5) yields a deterministic 2猫锟? square cross-section with perimeter 8.0
// and area 4.0. Validates that the rebar-line perimeter assertion scales to
// non-square cross-sections, extending 猫鹿鈥∶モ€樎疵︼拷?6 rebar coverage beyond unit
...
TEST( Section3dCapabilityTest, RectangularPrismMidSectionYieldsDeterministicRebarPerimeter )
{
    ...
    // a 2猫锟? square cross-section; bottom and top remain parallel and uncut.
    const Plane cut = Plane::FromPointAndNormal( Point3d{ 1.0, 1.0, 0.5 }, Vector3d{ 0.0, 0.0, 1.0 } );
    const auto section = Section( prism, cut );
    ASSERT_TRUE( section.success );
    ASSERT_TRUE( section.IsValid() );
...
TEST( Section3dCapabilityTest, RectangularPrismXAxisSectionYieldsDeterministicRebarPerimeter )
{
    ...
    // the two x-normal caps parallel and uncut 茅藛?2猫锟? rectangle in the yz-plane.
    const Plane cut = Plane::FromPointAndNormal( Point3d{ 1.0, 1.0, 0.5 }, Vector3d{ 1.0, 0.0, 0.0 } );
    const auto section = Section( prism, cut );
    ASSERT_TRUE( section.success );
    ASSERT_TRUE( section.IsValid() );
...
TEST( Section3dCapabilityTest, RectangularPrismYAxisSectionYieldsDeterministicRebarPerimeter )
{
    ...
    // y=1 cuts left(x=0)/right(x=2)/bottom(z=0)/top(z=1) 茅藛?2猫锟? rectangle in xz.
    const Plane cut2 = Plane::FromPointAndNormal( Point3d{ 1.0, 1.0, 0.5 }, Vector3d{ 0.0, 1.0, 0.0 } );
...
TEST( Section3dCapabilityTest, BrepRectangularPrismYAxisSectionYieldsDeterministicRebarPerimeter )
{
    ...
    const Plane cut3 = Plane::FromPointAndNormal( Point3d{ 1.0, 1.0, 0.5 }, Vector3d{ 0.0, 1.0, 0.0 } );
...
// mid-plane) yields a deterministic 1猫锟? square cross-section with perimeter 4.0
...
TEST( Section3dCapabilityTest, UnitCubeZAxisSectionYieldsDeterministicRebarPerimeter )
{
    ...
    const Plane cut = Plane::FromPointAndNormal( Point3d{ 0.5, 0.5, 0.5 }, Vector3d{ 0.0, 0.0, 1.0 } );
    const auto section = Section( cubeBody, cut );
    ASSERT_TRUE( section.success );
    ASSERT_TRUE( section.IsValid() );
