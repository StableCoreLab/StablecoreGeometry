...
using Geometry::PolyhedronBrepBodyConversion3d;
using Geometry::PolyhedronFace3d;
using Geometry::PolyhedronLoop3d;
using Geometry::PolyhedronMeshConversion3d;
...
namespace
{
    Point3d SkewPoint( const Point3d &point )
    {
        ...
        return Point3d{ point.x + 0.3 * point.z, point.y + 0.2 * point.x, point.z };
    }
    ...
    Plane SkewPlane( const Plane &plane )
    {
        ...
        const Vector3d transformedNormal{ n.x - 0.2 * n.y, n.y, -0.3 * n.x + 0.06 * n.y + n.z };
    ...
    PolyhedronFace3d SkewFace( const PolyhedronFace3d &face )
    {
        ...
        return PolyhedronFace3d( SkewPlane( face.SupportPlane() ), std::move( outer ),
                                 std::move( holes ) );
    }
    ...
    PolyhedronFace3d TranslateFace3d( const PolyhedronFace3d &face, const Vector3d &delta )
    {
        try
        {
            const Plane translatedPlane = Plane::FromPointAndNormal( face.SupportPlane().origin + delta,
    ...
    PolyhedronBody BuildDeformedUnitCubeBody()
    {
        ...
        // Support planes are the original axis-aligned planes of the unit cube 锟?    // intentionally
        // wrong for the three faces that contain v0.
    ...
    PolyhedronBody BuildDeformedUnitCubeWithDuplicateLoopBody()
    {
        ...
        faces[4] = PolyhedronFace3d( leftFace.SupportPlane(), PolyhedronLoop3d( std::move( loop ) ),
                                     CopyFaceHoles( leftFace ) );
        return PolyhedronBody( std::move( faces ) );
    }
    ...
    PolyhedronBody BuildDeformedUnitCubeWithDualDuplicateLoopBody()
    {
        ...
        loop.insert( loop.begin(), loop.front() );
        faces[2] = PolyhedronFace3d( frontFace.SupportPlane(), PolyhedronLoop3d( std::move( loop ) ),
                                     CopyFaceHoles( frontFace ) );
        return PolyhedronBody( std::move( faces ) );
    }
    ...
    PolyhedronBody BuildDualDeformedUnitCubeWithDualDuplicateLoopBody()
    {
        ...
        loop.insert( loop.begin(), loop.front() );
        faces[5] = PolyhedronFace3d( rightFace.SupportPlane(), PolyhedronLoop3d( std::move( loop ) ),
                                     CopyFaceHoles( rightFace ) );
        return PolyhedronBody( std::move( faces ) );
    }
    ...
    PolyhedronBody BuildMildlyNonPlanarCubeFaceBody()
    {
        ...
        faces[topFaceIndex] =
            PolyhedronFace3d( top.SupportPlane(), PolyhedronLoop3d( std::move( topVertices ) ) );
    ...
    PolyhedronBody BuildMildlyNonPlanarHoledFaceBody()
    {
        ...
        std::vector<Point3d> holeVertices{ Point3d{ 1.0, 1.0, 0.0 }, Point3d{ 3.0, 1.0, 0.0 },
                                           Point3d{ 3.0, 3.0, 0.0 }, Point3d{ 1.0, 3.0, 0.0 } };
        holeVertices[2].z += 0.03;

        const PolyhedronFace3d face(
            Plane::FromPointAndNormal( Point3d{ 0.0, 0.0, 0.0 }, Vector3d{ 0.0, 0.0, 1.0 } ), outer,
    ...
    {
        std::vector<Point3d> outer{ Point3d{ 0.0, 0.0, 0.12 }, Point3d{ 6.0, 0.0, 0.00 },
                                    Point3d{ 6.0, 6.0, 0.10 }, Point3d{ 0.0, 6.0, 0.00 } };
        std::vector<Point3d> hole{ Point3d{ 1.0, 1.0, 0.0 }, Point3d{ 5.0, 1.0, 0.0 },
                                   Point3d{ 5.0, 5.0, 0.0 }, Point3d{ 1.0, 5.0, 0.0 } };

        const PolyhedronFace3d face(
            Plane::FromPointAndNormal( Point3d{ 0.0, 0.0, 0.2 }, Vector3d{ 0.0, 0.0, 1.0 } ),
            PolyhedronLoop3d( std::move( outer ) ), { PolyhedronLoop3d( std::move( hole ) ) } );
        return PolyhedronBody( { face } );
    }
    ...
    PolyhedronBody BuildSharedEdgeHoleDominatedMixedContentBody()
    {
        ...
        std::vector<Point3d> hole{ Point3d{ 2.6, 0.4, 0.0 }, Point3d{ 5.4, 0.4, 0.0 },
                                   Point3d{ 5.4, 1.6, 0.0 }, Point3d{ 2.6, 1.6, 0.0 } };
    ...
    PolyhedronBody BuildSupportMismatchNearEqualSharedChainHoleDominatedMixedContentBody()
    {
        ...
        const PolyhedronFace3d faceA( mismatchedPlane, PolyhedronLoop3d( { a, b, c, d } ) );
        const PolyhedronFace3d faceB( mismatchedPlane, PolyhedronLoop3d( { b2, e, f, c2 } ),
                                      { PolyhedronLoop3d( std::move( hole ) ) } );
        const PolyhedronFace3d faceC( mismatchedPlane, PolyhedronLoop3d( { e2, g, h, f2 } ) );
        return PolyhedronBody( { faceA, faceB, faceC } );
    }

    PolyhedronBody
    BuildSupportMismatchNearEqualSharedChainHoleDominatedMixedContentWithDuplicateHoleBody()
    {
        const Plane mismatchedPlane =
            Plane::FromPointAndNormal( Point3d{ 0.0, 0.0, 0.2 }, Vector3d{ 0.0, 0.0, 1.0 } );
        ...
        std::vector<Point3d> hole{ Point3d{ 2.6, 0.4, 0.0 }, Point3d{ 5.4, 0.4, 0.0 },
                                   Point3d{ 5.4, 0.4, 0.0 }, Point3d{ 5.4, 1.6, 0.0 },
                                   Point3d{ 2.6, 1.6, 0.0 } };
    ...
    PolyhedronBody BuildSupportMismatchNearEqualSharedChainHoleDominatedFullCompositionBody()
    {
        ...
        const PolyhedronFace3d faceA( mismatchedPlane, PolyhedronLoop3d( { a, b, c, d } ) );
        const PolyhedronFace3d faceB( mismatchedPlane, PolyhedronLoop3d( { b2, m, e, f, c2 } ),
                                      { PolyhedronLoop3d( std::move( hole ) ) } );
        const PolyhedronFace3d faceC( mismatchedPlane, PolyhedronLoop3d( { e2, g, h, f2 } ) );
        return PolyhedronBody( { faceA, faceB, faceC } );
    }
    ...
    PolyhedronBody BuildCompositeRepairStressFaceBody()
    {
        std::vector<Point3d> outer{
            ...
            Point3d{ 4.0, 0.0, 0.0 }, Point3d{ 4.0, 4.0, 0.0 }, Point3d{ 0.0, 4.0, 0.0 },
            Point3d{ 0.0, 4.0, 0.0 },
        };
        ...
        std::vector<Point3d> hole{
            Point3d{ 1.0, 1.0, 0.0 }, Point3d{ 3.0, 1.0, 0.0 }, Point3d{ 3.0, 1.0, 0.0 },
            Point3d{ 3.0, 3.0, 0.0 }, Point3d{ 1.0, 3.0, 0.0 },
        };
    ...
    {
        const double s = 1e-5;
        std::vector<Point3d> outer{ Point3d{ 0.0, 0.0, 0.0 }, Point3d{ s, 0.0, 0.0 },
                                    Point3d{ s, s, 0.0 }, Point3d{ 0.0, s, 0.0 } };
    ...
    PolyhedronBody BuildTinyScaleNonPlanarHoledRepairBody()
    {
        ...
        std::vector<Point3d> outer{ Point3d{ 0.0, 0.0, 0.0 }, Point3d{ s, 0.0, 0.0 },
                                    Point3d{ s, s, 0.0 }, Point3d{ 0.0, s, 0.0 } };
        std::vector<Point3d> hole{ Point3d{ 0.3 * s, 0.3 * s, 0.0 }, Point3d{ 0.7 * s, 0.3 * s, 0.0 },
                                   Point3d{ 0.7 * s, 0.7 * s, 0.0 }, Point3d{ 0.3 * s, 0.7 * s, 0.0 } };
    ...
    {
        const double s = 1e-5;
        std::vector<Point3d> faceA{ Point3d{ 0.0, 0.0, 0.0 }, Point3d{ s, 0.0, 0.0 },
                                    Point3d{ s, s, 0.0 }, Point3d{ 0.0, s, 0.0 } };
        std::vector<Point3d> faceB{ Point3d{ 2.0 * s, 0.0, 0.0 }, Point3d{ 3.0 * s, 0.0, 0.0 },
                                    Point3d{ 3.0 * s, s, 0.0 }, Point3d{ 2.0 * s, s, 0.0 } };
    ...
    PolyhedronBody BuildTinyScaleNonPlanarMixedContentBody()
    {
        ...
        std::vector<Point3d> hole{ Point3d{ 0.3 * s, 0.3 * s, 0.0 }, Point3d{ 0.7 * s, 0.3 * s, 0.0 },
                                   Point3d{ 0.7 * s, 0.7 * s, 0.0 }, Point3d{ 0.3 * s, 0.7 * s, 0.0 } };
        std::vector<Point3d> plain{ Point3d{ 2.0 * s, 0.0, 0.0 }, Point3d{ 3.0 * s, 0.0, 0.0 },
                                    Point3d{ 3.0 * s, s, 0.0 }, Point3d{ 2.0 * s, s, 0.0 } };
    ...
    PolyhedronBody BuildTinyScaleNonPlanarSharedEdgeChainMixedContentBody()
    {
        ...
        std::vector<Point3d> hole{ Point3d{ 1.2 * s, 0.3 * s, 0.0 }, Point3d{ 1.8 * s, 0.3 * s, 1.0e-6 },
                                   Point3d{ 1.8 * s, 0.7 * s, 0.0 }, Point3d{ 1.2 * s, 0.7 * s, 0.0 } };
        ...
        const PolyhedronFace3d faceB(
            Plane::FromPointAndNormal( Point3d{ s, 0.0, 2e-6 }, Vector3d{ 0.0, 0.0, 1.0 } ),
            PolyhedronLoop3d( { b, e, f, c } ), { PolyhedronLoop3d( std::move( hole ) ) } );
        const PolyhedronFace3d faceC(
            Plane::FromPointAndNormal( Point3d{ 2.0 * s, 0.0, 2e-6 }, Vector3d{ 0.0, 0.0, 1.0 } ),
            PolyhedronLoop3d( { e, g, h, f } ) );
        return PolyhedronBody( { faceA, faceB, faceC } );
    ...
    PolyhedronBody BuildTinyScaleSharedEdgeChainMixedContentWithDuplicateHoleBody()
    {
        ...
        std::vector<Point3d> hole{ Point3d{ 1.2 * s, 0.3 * s, 0.0 }, Point3d{ 1.8 * s, 0.3 * s, 1.0e-6 },
                                   Point3d{ 1.8 * s, 0.3 * s, 1.0e-6 }, Point3d{ 1.8 * s, 0.7 * s, 0.0 },
    ...
    PolyhedronBody BuildTinyScaleSharedChainMixedContentWithCollinearLeadingBody()
    {
        ...
        const PolyhedronFace3d faceB(
            Plane::FromPointAndNormal( Point3d{ s, 0.0, 2e-6 }, Vector3d{ 0.0, 0.0, 1.0 } ),
            PolyhedronLoop3d( { b, m, e, f, c } ), { PolyhedronLoop3d( std::move( hole ) ) } );
        const PolyhedronFace3d faceC(
            Plane::FromPointAndNormal( Point3d{ 2.0 * s, 0.0, 2e-6 }, Vector3d{ 0.0, 0.0, 1.0 } ),
            PolyhedronLoop3d( { e, g, h, f } ) );
    ...
    PolyhedronBody BuildTinyScaleSharedChainMixedContentSupportPlaneMismatchBody()
    {
        ...
        std::vector<Point3d> hole{ Point3d{ 1.2 * s, 0.3 * s, 0.0 }, Point3d{ 1.8 * s, 0.3 * s, 8e-7 },
                                   Point3d{ 1.8 * s, 0.7 * s, 0.0 }, Point3d{ 1.2 * s, 0.7 * s, 0.0 } };
    ...
    PolyhedronBody BuildTinyScaleSharedChainMixedContentSupportMismatchWithDuplicateHoleBody()
    {
        ...
        std::vector<Point3d> hole{ Point3d{ 1.2 * s, 0.3 * s, 0.0 }, Point3d{ 1.8 * s, 0.3 * s, 8e-7 },
                                   Point3d{ 1.8 * s, 0.3 * s, 8e-7 }, Point3d{ 1.8 * s, 0.7 * s, 0.0 },
                                   Point3d{ 1.2 * s, 0.7 * s, 0.0 } };
    ...
    PolyhedronBody BuildTinyScaleClosedTetrahedronBody()
    {
        ...
        // normals vary 锟?the per-face refit must compute the correct orientation.
        const Plane mismatchedPlane =
            Plane::FromPointAndNormal( Point3d{ 0.0, 0.0, 2e-6 }, Vector3d{ 0.0, 0.0, 1.0 } );
    ...
    PolyhedronBody BuildTinyScaleTriangularFaceChainBody()
    {
        ...
        // that face's refit-plane is exactly 0 锟?no projection occurs and the
    ...
    PolyhedronBody BuildTinyScaleTriangularFanBody()
    {
        ...
        // Key: apex is one of the 3 defining vertices of all 4 triangles 锟?after
        // per-face refit its distance to each refit-plane is exactly 0 锟?apex is
        // never projected 锟?it is preserved at its original position in all faces
        // 锟?FindOrAddBrepVertex merges it exactly once.
    ...
    PolyhedronBody BuildNearEqualSharedEdgeQuadPairBody()
    {
        ...
        return PolyhedronBody( { PolyhedronFace3d( plane, PolyhedronLoop3d( { a, b, c, d } ) ),
    ...
    PolyhedronBody BuildSupportMismatchNearEqualClosedTetrahedronBody()
    {
        ...
        return PolyhedronBody( { PolyhedronFace3d( mismatched, PolyhedronLoop3d( { v0a, v1, v2 } ) ),
    ...
    PolyhedronBody BuildSupportMismatchNearEqualSharedChainMixedContentWithDuplicateHoleBody()
    {
        ...
        return PolyhedronBody(
            { PolyhedronFace3d( mismatched, PolyhedronLoop3d( { a, b, c, d } ) ),
              PolyhedronFace3d( mismatched,
                                PolyhedronLoop3d( { b + Vector3d{ dx, 0.0, 0.0 }, e, f,
                                                    c + Vector3d{ dx, 0.0, 0.0 } } ),
                                { PolyhedronLoop3d( std::move( hole ) ) } ),
              PolyhedronFace3d( mismatched, PolyhedronLoop3d( { e2, g, h, f2 } ) ) } );
    }
    ...
    PolyhedronBody BuildSupportMismatchNearEqualSharedChainFullCompositionBody()
    {
        ...
        return PolyhedronBody(
            { PolyhedronFace3d( mismatched, PolyhedronLoop3d( { a, b, c, d } ) ),
              PolyhedronFace3d( mismatched,
                                PolyhedronLoop3d( { b + Vector3d{ dx, 0.0, 0.0 }, m, e, f,
                                                    c + Vector3d{ dx, 0.0, 0.0 } } ),
                                { PolyhedronLoop3d( std::move( hole ) ) } ),
              PolyhedronFace3d( mismatched, PolyhedronLoop3d( { e2, g, h, f2 } ) ) } );
    }
    ...
    PolyhedronBody BuildSupportMismatchNearEqualClosedTetrahedronDualVerticesBody()
    {
        ...
        return PolyhedronBody( { PolyhedronFace3d( mismatched, PolyhedronLoop3d( { v0a, v1a, v2 } ) ),
    ...
    PolyhedronBody BuildSupportMismatchNearEqualClosedTetrahedronDualVerticesWithDualDuplicateLoopBody()
    {
        ...
        const PolyhedronBody base =
            BuildSupportMismatchNearEqualClosedTetrahedronDualVerticesWithDuplicateLoopBody();
        std::vector<PolyhedronFace3d> faces = base.Faces();
        if( faces.size() != 4 )
        {
            return PolyhedronBody();
    ...
    PolyhedronBody BuildSupportMismatchNearEqualClosedTetrahedronAllVerticesWithDualDuplicateLoopBody()
    {
        ...
        // variant and inject another duplicate leading vertex on a second face.
        const PolyhedronBody base =
            BuildSupportMismatchNearEqualClosedTetrahedronAllVerticesWithDuplicateLoopBody();
        std::vector<PolyhedronFace3d> faces = base.Faces();
        if( faces.size() != 4 )
        {
            return PolyhedronBody();
    ...
    PolyhedronBody BuildSupportMismatchNearEqualClosedPrismDualVerticesWithDualDuplicateLoopBody()
    {
        ...
        const PolyhedronBody base =
            BuildSupportMismatchNearEqualClosedPrismDualVerticesWithDuplicateLoopBody();
        std::vector<PolyhedronFace3d> faces = base.Faces();
        if( faces.size() != 5 )
        {
            return PolyhedronBody();
    ...
    PolyhedronBody BuildSupportMismatchNearEqualClosedPrismAllVerticesWithDuplicateLoopBody()
    {
        ...
        faces[2] =
            PolyhedronFace3d( sideFace.SupportPlane(), PolyhedronLoop3d( std::move( vertices ) ) );
        return PolyhedronBody( std::move( faces ) );
    }
    PolyhedronBody BuildSupportMismatchNearEqualClosedPrismAllVerticesWithDualDuplicateLoopBody()
    {
        ...
        // variant and inject another duplicate leading vertex on a second side face.
        const PolyhedronBody base =
            BuildSupportMismatchNearEqualClosedPrismAllVerticesWithDuplicateLoopBody();
        std::vector<PolyhedronFace3d> faces = base.Faces();
        if( faces.size() != 5 )
        {
            return PolyhedronBody();
    ...
    {
        // Tiny-scale 2脳1脳1 rectangular box (pure-quad closed shell) where all 8
    ...
    PolyhedronBody BuildSupportMismatchNearEqualClosedCuboidAllVerticesWithDualDuplicateLoopBody()
    {
        ...
        const PolyhedronBody base =
            BuildSupportMismatchNearEqualClosedCuboidAllVerticesWithDuplicateLoopBody();
        std::vector<PolyhedronFace3d> faces = base.Faces();
        if( faces.size() != 6 )
        {
            return PolyhedronBody();
    ...
    PolyhedronBody BuildSupportMismatchNearEqualClosedCuboidDualVerticesWithDualDuplicateLoopBody()
    {
        ...
        const PolyhedronBody base =
            BuildSupportMismatchNearEqualClosedCuboidDualVerticesWithDuplicateLoopBody();
        std::vector<PolyhedronFace3d> faces = base.Faces();
        if( faces.size() != 6 )
        {
            return PolyhedronBody();
    ...
    PolyhedronBody BuildSupportMismatchNearEqualClosedCuboidTripleVerticesWithDualDuplicateLoopBody()
    {
        ...
        const PolyhedronBody base =
            BuildSupportMismatchNearEqualClosedCuboidTripleVerticesWithDuplicateLoopBody();
        std::vector<PolyhedronFace3d> faces = base.Faces();
        if( faces.size() != 6 )
        {
            return PolyhedronBody();
    ...
    void AssertClosedCuboidAllVerticesRepresentativeTargets( const BrepBody &body )
    {
        ...
        const std::vector<Point3d> expectedPoints{ Point3d{ 0.0, 0.0, 0.0 },
...
// High-fidelity feature-preserving conversion and non-planar polyhedron鈫払rep
...
TEST( Conversion3dCapabilityTest, UnitCubePolyhedronBodyConvertsToTriangleMesh )
{
    ...
    // Each of the 6 quad faces is split into 2 triangles 锟?12 total
    ASSERT_EQ( result.mesh.TriangleCount(), 12 );
    // Total surface area of a unit cube = 6 脳 (1脳1) = 6.0
...
TEST( Conversion3dCapabilityTest, NearEqualSharedEdgeVerticesUseRepresentativeAverageTarget )
{
    ...
    for( std::size_t i = 0; i < result.body.VertexCount(); ++i )
    {
        ...
        if( std::abs( point.y ) < 1e-12 && std::abs( point.z ) < 1e-12 && point.x > 0.5 * s &&
            point.x < 1.5 * s )
        {
            ++sharedBLikeCount;
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualSharedEdgeRepairsWithRepresentativeAverageTarget )
{
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualSharedEdgeChainRepairsWithRepresentativeAverageTargets )
{
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualSharedCornerFanRepairsWithRepresentativeAverageTarget )
{
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedTetrahedronRepairsWithRepresentativeAverageTarget )
{
...
// on the middle face.
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualSharedEdgeChainWithDuplicateRepairsWithRepresentativeAverageTargets )
{
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualSharedChainMixedContentWithDuplicateHoleRepairsToBrepBody )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualSharedChainMixedContentWithDuplicateHoleBody();
    ASSERT_FALSE( body.IsValid() );
    ASSERT_EQ( body.FaceCount(), 3 );
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualSharedChainDualDuplicateFullCompositionRepairsToBrepBody )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualSharedChainDualDuplicateFullCompositionBody();
    ASSERT_FALSE( body.IsValid() );
    ASSERT_EQ( body.FaceCount(), 3 );
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedTetrahedronDualVerticesRepairsWithRepresentativeAverageTarget )
{
    ...
    for( std::size_t i = 0; i < result.body.VertexCount(); ++i )
    {
        ...
        if( std::abs( point.y ) < 1e-12 && std::abs( point.z - 1.2e-6 ) < 1e-12 && point.x > 0.5 * s &&
            point.x < 1.5 * s )
        {
            ++sharedV1Count;
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualClosedTetrahedronDualVerticesWithDuplicateLoopRepairsWithRepresentativeAverageTarget )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedTetrahedronDualVerticesWithDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualClosedTetrahedronDualVerticesWithDualDuplicateLoopRepairsWithRepresentativeAverageTarget )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedTetrahedronDualVerticesWithDualDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
    ASSERT_EQ( body.FaceCount(), 4 );
    const PolyhedronBrepBodyConversion3d result = ConvertToBrepBody( body );
    ASSERT_TRUE( result.success );
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedTetrahedronAllVerticesRepairsWithRepresentativeAverageTarget )
{
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualClosedTetrahedronAllVerticesWithDuplicateLoopRepairsWithRepresentativeAverageTarget )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedTetrahedronAllVerticesWithDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualClosedTetrahedronAllVerticesWithDualDuplicateLoopRepairsWithRepresentativeAverageTarget )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedTetrahedronAllVerticesWithDualDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
    ASSERT_EQ( body.FaceCount(), 4 );
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedPrismDualVerticesRepairsWithRepresentativeAverageTarget )
{
    ...
    for( std::size_t i = 0; i < result.body.VertexCount(); ++i )
    {
        ...
        if( std::abs( point.y ) < 1e-12 && point.x > 0.5 * s && point.x < 1.5 * s && point.z > 0.5 * s &&
            point.z < 1.5 * s )
        {
            ++sharedV4Count;
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualClosedPrismDualVerticesWithDuplicateLoopRepairsWithRepresentativeAverageTarget )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedPrismDualVerticesWithDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualClosedPrismDualVerticesWithDualDuplicateLoopRepairsWithRepresentativeAverageTarget )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedPrismDualVerticesWithDualDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
    ASSERT_EQ( body.FaceCount(), 5 );
    const PolyhedronBrepBodyConversion3d result = ConvertToBrepBody( body );
    ASSERT_TRUE( result.success );
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedPrismAllVerticesRepairsWithRepresentativeAverageTarget )
{
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualClosedPrismAllVerticesWithDuplicateLoopRepairsWithRepresentativeAverageTarget )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedPrismAllVerticesWithDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualClosedPrismAllVerticesWithDualDuplicateLoopRepairsWithRepresentativeAverageTarget )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedPrismAllVerticesWithDualDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
    ASSERT_EQ( body.FaceCount(), 5 );
    const PolyhedronBrepBodyConversion3d result = ConvertToBrepBody( body );
    ASSERT_TRUE( result.success );
...
TEST( Conversion3dCapabilityTest,
      DeformedCubeWithDualDuplicateLoopRepairsToClosedSharedTopologyBrepBody )
{
...
// stable when one adjacent face also needs duplicate-loop normalization.
TEST( Conversion3dCapabilityTest,
      DualDeformedCubeWithDuplicateLoopRepairsToClosedSharedTopologyBrepBody )
{
...
TEST( Conversion3dCapabilityTest,
      DualDeformedCubeWithDualDuplicateLoopRepairsToClosedSharedTopologyBrepBody )
{
...
TEST( Conversion3dCapabilityTest,
      SharedEdgeHoleDominatedMixedContentRepairsToPlanarSharedTopologyBrepBody )
{
...
TEST( Conversion3dCapabilityTest,
      SharedChainHoleDominatedMixedContentRepairsToPlanarSharedTopologyBrepBody )
{
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualSharedChainHoleDominatedMixedContentRepairsWithRepresentativeAverageTarget )
{
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualSharedChainHoleDominatedMixedContentWithDuplicateHoleRepairsWithRepresentativeAverageTarget )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualSharedChainHoleDominatedMixedContentWithDuplicateHoleBody();
    ASSERT_FALSE( body.IsValid() );
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualSharedChainHoleDominatedFullCompositionRepairsWithRepresentativeAverageTarget )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualSharedChainHoleDominatedFullCompositionBody();
    ASSERT_FALSE( body.IsValid() );
    ASSERT_EQ( body.FaceCount(), 3 );
...
TEST( Conversion3dCapabilityTest,
      TinyScaleSupportMismatchSharedEdgeChainWithDuplicateRepairsWithSharedTopology )
{
...
TEST( Conversion3dCapabilityTest,
      TinyScaleSharedChainMixedContentSupportMismatchWithDuplicateHoleRepairsToBrepBody )
{
    const PolyhedronBody body =
        BuildTinyScaleSharedChainMixedContentSupportMismatchWithDuplicateHoleBody();
    ASSERT_FALSE( body.IsValid() );
    ASSERT_EQ( body.FaceCount(), 3 );
...
// that face's refit-plane is exactly 0 锟?no projection divergence.  The
// result is VertexCount=5 and EdgeCount=7 (2 shared edges properly reused).
TEST( Conversion3dCapabilityTest,
      TinyScaleTriangularFaceChainRepairsToBrepBodyWithSharedEdgeConsistency )
{
...
// defining vertex of all four triangles 锟?distance 0 from each refit-plane 锟?// never projected
// 锟?exact merge.  Four radial edges are each used twice; four outer edges are each used once 锟?the
// open boundary is deterministic.
...
TEST( Conversion3dCapabilityTest, PlanarHoledBrepBodyConvertsToMeshWithExpectedArea )
{
    ...
    const CurveOnSurface outerTrim( supportSurface, Polyline2d(
                                                        {
                                                            Point2d{ 0.0, 0.0 },
                                                            Point2d{ 4.0, 0.0 },
                                                            Point2d{ 4.0, 4.0 },
    ...
    const CurveOnSurface holeTrim( supportSurface, Polyline2d(
                                                       {
                                                           Point2d{ 1.0, 1.0 },
                                                           Point2d{ 3.0, 1.0 },
                                                           Point2d{ 3.0, 3.0 },
...
TEST( Conversion3dCapabilityTest, PlanarMultiFaceBrepBodyConvertsToMeshWithExpectedArea )
{
    std::vector<BrepVertex> vertices{
        ...
        BrepVertex( Point3d{ 2.0, 2.0, 0.0 } ), BrepVertex( Point3d{ 0.0, 2.0, 0.0 } ),
        // Face B rectangle: area 2
        BrepVertex( Point3d{ 3.0, 0.0, 0.0 } ), BrepVertex( Point3d{ 4.0, 0.0, 0.0 } ),
        BrepVertex( Point3d{ 4.0, 2.0, 0.0 } ), BrepVertex( Point3d{ 3.0, 2.0, 0.0 } )
    };
    ...
    const CurveOnSurface trimA( supportA, Polyline2d(
                                              {
                                                  Point2d{ 0.0, 0.0 },
                                                  Point2d{ 2.0, 0.0 },
                                                  Point2d{ 2.0, 2.0 },
                                              ...
                                              PolylineClosure::Closed ) );
    const CurveOnSurface trimB( supportB, Polyline2d(
                                              {
                                                  Point2d{ 3.0, 0.0 },
                                                  Point2d{ 4.0, 0.0 },
                                                  Point2d{ 4.0, 2.0 },
    ...
    const BrepFace faceA( std::shared_ptr<Surface>( planeSurface.Clone().release() ), outerA, {}, trimA,
                          {} );
    const BrepFace faceB( std::shared_ptr<Surface>( planeSurface.Clone().release() ), outerB, {}, trimB,
                          {} );
...
TEST( Conversion3dCapabilityTest, PlanarSharedEdgeBrepBodyConvertsToMeshWithSharedVertices )
{
    ...
    auto makeTrim = [&]( const std::vector<Point2d> &points ) {
        return CurveOnSurface( std::shared_ptr<Surface>( planeSurface.Clone().release() ),
...
TEST( Conversion3dCapabilityTest, PlanarHoledAndMultiFaceBrepBodyConvertsToMeshWithExpectedArea )
{
    std::vector<BrepVertex> vertices{
        ...
        BrepVertex( Point3d{ 3.0, 3.0, 0.0 } ), BrepVertex( Point3d{ 1.0, 3.0, 0.0 } ),
        // Face B rectangle (area 2)
        BrepVertex( Point3d{ 5.0, 0.0, 0.0 } ), BrepVertex( Point3d{ 6.0, 0.0, 0.0 } ),
        BrepVertex( Point3d{ 6.0, 2.0, 0.0 } ), BrepVertex( Point3d{ 5.0, 2.0, 0.0 } )
    };
    ...
    const BrepLoop outerA( { BrepCoedge( 0, false ), BrepCoedge( 1, false ), BrepCoedge( 2, false ),
                             BrepCoedge( 3, false ) } );
    const BrepLoop holeA( { BrepCoedge( 4, false ), BrepCoedge( 5, false ), BrepCoedge( 6, false ),
                            BrepCoedge( 7, false ) } );
    ...
    const BrepFace faceA( std::shared_ptr<Surface>( planeSurface.Clone().release() ), outerA, { holeA },
                          outerTrimA, { holeTrimA } );
    const BrepFace faceB( std::shared_ptr<Surface>( planeSurface.Clone().release() ), outerB, {},
                          outerTrimB, {} );
    const BrepBody body( vertices, edges, { BrepShell( { faceA, faceB }, false ) } );
    ASSERT_TRUE( body.IsValid() );
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedCuboidAllVerticesRepairsWithRepresentativeAverageTarget )
{
...
TEST(
    Conversion3dCapabilityTest,
    SupportMismatchNearEqualClosedCuboidAllVerticesWithDuplicateLoopRepairsWithRepresentativeAverageTarget )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedCuboidAllVerticesWithDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
...
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedCuboidAllVerticesWithDualDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
    ASSERT_EQ( body.FaceCount(), 6 );
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedCuboidDualVerticesWithDuplicateLoopRepairsToValidBrepBody )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedCuboidDualVerticesWithDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
    ...
    for( std::size_t i = 0; i < result.body.VertexCount(); ++i )
    {
        ...
        if( point.x > 1.5 * s && point.x < 2.5 * s && std::abs( point.y - s ) < 1e-12 &&
            std::abs( point.z - s ) < 1e-12 )
        {
            ++sharedV6Count;
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedCuboidDualVerticesWithDualDuplicateLoopRepairsToValidBrepBody )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedCuboidDualVerticesWithDualDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
    ASSERT_EQ( body.FaceCount(), 6 );
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedCuboidDualVerticesRepairsToValidBrepBody )
{
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedCuboidTripleVerticesRepairsToValidBrepBody )
{
    ...
    for( std::size_t i = 0; i < result.body.VertexCount(); ++i )
    {
        ...
        if( point.x > 1.5 * s && point.x < 2.5 * s && std::abs( point.y ) < 1e-12 &&
            std::abs( point.z ) < 1e-12 )
        {
            ++sharedV1Count;
            ASSERT_LT( std::abs( point.x - expectedV1X ), 1e-10 );
        }
...
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedCuboidTripleVerticesWithDuplicateLoopRepairsToValidBrepBody )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedCuboidTripleVerticesWithDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
...
// when duplicate-loop-normalization is required on two faces simultaneously.
TEST( Conversion3dCapabilityTest,
      SupportMismatchNearEqualClosedCuboidTripleVerticesWithDualDuplicateLoopRepairsToValidBrepBody )
{
    const PolyhedronBody body =
        BuildSupportMismatchNearEqualClosedCuboidTripleVerticesWithDualDuplicateLoopBody();
    ASSERT_FALSE( body.IsValid() );
    ASSERT_EQ( body.FaceCount(), 6 );
