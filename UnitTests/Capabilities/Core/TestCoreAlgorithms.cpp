...
TEST(CoreAlgorithmsTest, CoversCurrentCapabilities)
{
    ...
    const SegmentProjection2d arcProjection =
        ProjectPointToArcSegment(Point2d{1.0, 1.0}, arc, true);
    ...
    const Polyline2d holeRing = Geometry::Test::MakeRectangleHoleRing(Point2d{1.0, 1.0}, Point2d{3.0, 3.0});
    ...
    const Polyline2d closedOpen = Close(Polyline2d({Point2d{0.0, 0.0}, Point2d{1.0, 0.0}, Point2d{1.0, 1.0}}, PolylineClosure::Open));
