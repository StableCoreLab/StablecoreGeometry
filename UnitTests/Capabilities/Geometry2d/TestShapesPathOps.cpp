...
TEST( ShapesPathopsTest, CoversCurrentCapabilities )
{
    ...
    GEOMETRY_TEST_ASSERT_POINT_NEAR( rectangle.ToPolygon().OuterRing().PointAt( 0 ),
                                     ( Point2d{ -2.0, -1.0 } ), 1e-12 );
    ...
    const Polyline2d path( { Point2d{ 0.0, 0.0 }, Point2d{ 3.0, 0.0 }, Point2d{ 3.0, 4.0 } },
    ...
    GEOMETRY_TEST_ASSERT_POINT_NEAR( sub.PointAt( sub.PointCount() - 1 ), ( Point2d{ 3.0, 2.0 } ),
                                     1e-12 );

    const Polygon2d square( Polyline2d(
    ...
    const Polygon2d donut( Polyline2d( { Point2d{ 0.0, 0.0 }, Point2d{ 8.0, 0.0 }, Point2d{ 8.0, 8.0 },
                                         Point2d{ 0.0, 8.0 } },
                                       PolylineClosure::Closed ),
                           { Polyline2d( { Point2d{ 3.0, 3.0 }, Point2d{ 3.0, 5.0 }, Point2d{ 5.0, 5.0 },
                                           Point2d{ 5.0, 3.0 } },
                                         PolylineClosure::Closed ) } );
    const auto donutCut =
        CutPolygon( donut, LineSegment2d( Point2d{ 4.0, -2.0 }, Point2d{ 4.0, 10.0 } ) );
    ...
    const MultiPolyline2d closedLines{ Polyline2d( { Point2d{ 0.0, 0.0 }, Point2d{ 2.0, 0.0 },
                                                     Point2d{ 2.0, 2.0 }, Point2d{ 0.0, 2.0 } },
                                                   PolylineClosure::Closed ),
                                       Polyline2d( { Point2d{ 5.0, 5.0 }, Point2d{ 6.0, 5.0 },
    ...
    const Polygon2d noisyBoundary( Polyline2d(
        { Point2d{ 0.0, 0.0 }, Point2d{ 4.0, 0.0 }, Point2d{ 4.0, 2.0 }, Point2d{ 4.0, 2.000000001 },
          Point2d{ 4.0, 4.0 }, Point2d{ 0.0, 4.0 }, Point2d{ 0.0, 2.000000001 }, Point2d{ 0.0, 2.0 } },
        PolylineClosure::Closed ) );
