...
TEST(RelationBooleanTest, CoversCurrentCapabilities)
{
    ...
    GEOMETRY_TEST_ASSERT_NEAR(
        TotalArea(Intersect(duplicateEdgeFamilyA, duplicateEdgeFamilyB)),
        12.0,
        1e-8);
    GEOMETRY_TEST_ASSERT_NEAR(
        TotalArea(Union(duplicateEdgeFamilyA, duplicateEdgeFamilyB)),
        36.0,
        1e-8);
    GEOMETRY_TEST_ASSERT_NEAR(
        TotalArea(Difference(duplicateEdgeFamilyA, duplicateEdgeFamilyB)),
        12.0,
        1e-8);
    ...
    const Polygon2d repeatedCollinearChainB(
        Polyline2d(
            ...
            PolylineClosure::Closed));
    GEOMETRY_TEST_ASSERT_NEAR(
        TotalArea(Intersect(repeatedCollinearChainA, repeatedCollinearChainB)),
        6.000000003,
        1e-8);
    GEOMETRY_TEST_ASSERT_NEAR(
        TotalArea(Union(repeatedCollinearChainA, repeatedCollinearChainB)),
        24.0,
        1e-8);
    GEOMETRY_TEST_ASSERT_NEAR(
        TotalArea(Difference(repeatedCollinearChainA, repeatedCollinearChainB)),
        11.999999997,
        1e-8);
}
...
TEST(RelationBooleanTest, HandlesHigherDegreeRepeatedCollinearFamilyOverlap)
{
    ...
    GEOMETRY_TEST_ASSERT_NEAR(
        TotalArea(Intersect(repeatedFamilyA, repeatedFamilyB)),
        8.0 - delta,
        1e-8);
    GEOMETRY_TEST_ASSERT_NEAR(
        TotalArea(Union(repeatedFamilyA, repeatedFamilyB)),
        28.0 - delta,
        1e-8);
    GEOMETRY_TEST_ASSERT_NEAR(
        TotalArea(Difference(repeatedFamilyA, repeatedFamilyB)),
        16.0 - delta,
        1e-8);
}
