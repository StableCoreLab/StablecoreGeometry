...
namespace Geometry
{
    ...
    public:
        ...
        [[nodiscard]] std::size_t CoedgeCount() const { return coedges_.size(); }

        [[nodiscard]] BrepCoedge CoedgeAt( std::size_t index ) const { return coedges_.at( index ); }

        [[nodiscard]] const std::vector<BrepCoedge> &Coedges() const { return coedges_; }
