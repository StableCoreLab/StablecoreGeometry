...
namespace Geometry
{
    ...
    [[nodiscard]] GEOMETRY_API BodyBooleanResult3d IntersectBodies( const BrepBody &first,
                                                                    const BrepBody &second,
                                                                    BodyBooleanOptions3d options = {} );

    [[nodiscard]] GEOMETRY_API BodyBooleanResult3d UnionBodies( const BrepBody &first,
                                                                const BrepBody &second,
                                                                BodyBooleanOptions3d options = {} );

    [[nodiscard]] GEOMETRY_API BodyBooleanResult3d DifferenceBodies( const BrepBody &first,
                                                                     const BrepBody &second,
                                                                     BodyBooleanOptions3d options = {} );
