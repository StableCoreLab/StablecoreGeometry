...
[[nodiscard]] GEOMETRY_API AxisProjection2d ProjectPointToAxis(const Point2d& point, const Segment2d& segment);
...
[[nodiscard]] GEOMETRY_API SegmentTrim2d TrimSegment(
    const Segment2d& segment,
