...
namespace Geometry
{
    struct Box3d
    {
        ...
        [[nodiscard]] static constexpr Box3d FromMinMax( const Point3d &minValue,
                                                         const Point3d &maxValue )
        {
        ...
        {
            return Point3d{ ( minPoint.x + maxPoint.x ) * 0.5, ( minPoint.y + maxPoint.y ) * 0.5,
        ...
        [[nodiscard]] std::string DebugString() const
        {
            ...
            stream << "Box3d{minPoint=" << minPoint.DebugString()
                   << ", maxPoint=" << maxPoint.DebugString()
