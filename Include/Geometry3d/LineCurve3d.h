...
namespace Geometry
{
    ...
    public:
        LineCurve3d() = default;
        LineCurve3d( Line3d line, Intervald parameterRange ) :
            line_( line ),
            parameterRange_( parameterRange )
        {
        }

        [[nodiscard]] static LineCurve3d FromLine( const Line3d &line,
                                                   Intervald parameterRange = Intervald{ -1.0, 1.0 } )
        {
        ...
        [[nodiscard]] Intervald ParameterRange() const override { return parameterRange_; }
        ...
        [[nodiscard]] bool IsClosed( const GeometryTolerance3d &tolerance = {} ) const override
        {
            ...
            return PointAt( StartParameter() )
                .AlmostEquals( PointAt( EndParameter() ), tolerance.distanceEpsilon );
        }
        ...
        [[nodiscard]] Line3d Line() const { return line_; }
