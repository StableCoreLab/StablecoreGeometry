...
namespace Geometry
{
    ...
    public:
        ...
        [[nodiscard]] virtual SurfaceEval3d Evaluate( double u, double v,
        ...
        [[nodiscard]] double StartU() const { return URange().min; }

        [[nodiscard]] double EndU() const { return URange().max; }

        [[nodiscard]] double StartV() const { return VRange().min; }

        [[nodiscard]] double EndV() const { return VRange().max; }
    };
}  // namespace Geometry
